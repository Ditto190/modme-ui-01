...
- (cursor) Finalize Phase 0 merge hybrids — shared-deps worktree setup grafts git-hooks + KM/session bootstrap (5/5); KM quickstart keeps ADR-0013 planes + Obsidian sidecar
