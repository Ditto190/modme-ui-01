...
# Define ToolContext as Any since module is missing
ToolContext = Any

# Paths
# Script is in UniversalWorkbench/generate_schemas.py
# Apps are in UniversalWorkbench/apps/agent-generator
current_dir = Path(__file__).parent.resolve()
AGENT_GENERATOR_ROOT = current_dir / "apps" / "agent-generator"
...
def generate_agent_prompt(
    ...
    try:
        ...
        output_path = Path(output_file) if output_file else OUTPUT_DIR / "agent_prompt.md"
...
def generate_all(
    ...
    try:
        ...
        overall_status = "success" if (
            schemas_result["status"] in ("success", "warning") and
