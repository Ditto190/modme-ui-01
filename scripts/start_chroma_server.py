...
def check_chroma_installed() -> bool:
    ...
    try:
        import chromadb  # noqa: F401, E402 - existence check
...
def start_server_embedded(
    ...
    try:
        import chromadb  # noqa: F401, E402 - used below
    ...
    try:
        ...
        from chromadb.server import create_app  # noqa: F401, E402 - used below
    except ImportError:
...
def main():
    ...
    parser.add_argument("--log-file", help="Log file path (background mode only)")
    parser.add_argument(
        "--show-config", action="store_true", help="Show connection info and exit"
    )
