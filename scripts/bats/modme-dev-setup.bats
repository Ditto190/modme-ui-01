...
@test "session manifest lists launch phase" {
  grep -q '"launch"' "$REPO_ROOT/scripts/modme-session.manifest.json"
  grep -q 'launch:health' "$REPO_ROOT/scripts/modme-session.manifest.json"
