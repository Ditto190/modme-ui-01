...
const SKILL_MAPPINGS = [
  {
    name: "DAG task runner skill",
    paths: [
      ".cursor/skills/dag-task-runner/",
      ".vendor/cursor-cookbook/sdk/dag-task-runner/",
    ],
    skill: ".cursor/skills/dag-task-runner/SKILL.md",
    checks: [
      "Keep runner CLI flags, model defaults, and canvas path conventions aligned with scripts/run_dag.ts.",
    ],
  },
  {
    name: "Agent workbench orchestration",
    paths: [
      ".cursor/skills/agent-workbench-orchestration/",
      "GenerativeUI_monorepo/UniversalWorkbench/apps/agent/",
    ],
    skill: ".cursor/skills/agent-workbench-orchestration/SKILL.md",
    checks: ["Document workflow, tool, or goal-contract changes for multi-agent workbench runs."],
  },
  {
    name: "Multi-agent worktrees",
    paths: ["scripts/new-agent-worktree.ps1", "scripts/init-worktrees.ps1", "docs/multi-agent-worktrees.md"],
    skill: "docs/multi-agent-worktrees.md",
    checks: ["Update port allocation, setup scripts, or worktree workflow docs when scripts change."],
  },
  {
    name: "Shared schemas",
    paths: ["GenerativeUI_monorepo/packages/shared-schemas/", "GenerativeUI_monorepo/apps/agent-server/src/models/"],
    skill: "GenerativeUI_monorepo/AGENTS.md",
    checks: ["Note schema or websocket contract changes that affect dashboard or agent clients."],
  },
  {
    name: "Web dashboard UI",
    paths: ["GenerativeUI_monorepo/apps/web-dashboard/src/"],
    skill: "GenerativeUI_monorepo/AGENTS.md",
    checks: ["Capture new UI patterns, agent panel behavior, or streaming component conventions."],
  },
];
