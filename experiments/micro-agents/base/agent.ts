...
async function callClaude(userMessage: string): Promise<string> {
  ...
  const response = await anthropic.messages.create({
    ...
    system: 'You are a helpful coding assistant. Use the bash tool to help with programming tasks. Be concise and practical.',
    tools: [{
      name: 'bash',
      description: 'Execute bash commands to read, write, or manipulate files',
      input_schema: {
