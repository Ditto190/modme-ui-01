<!--
This prompt file is specifically designed for v0.dev (Vercel's AI-powered UI generator).
It provides instructions for generating React components with v0.dev's interface and tooling.
This file is maintained separately from v0-copilot.prompt.md to support different AI tooling workflows.
-->
