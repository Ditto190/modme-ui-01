...
Read local files from `.github/aw/` (vendored from gh-aw v0.71.5). For prompts missing locally, run `.\scripts\setup-gh-aw-assets.ps1` or fetch from [llms.txt](https://github.github.com/gh-aw/llms.txt).
