---
timestamp: 2026-07-12T01:28:58+10:00
agent: "human"
...
file_name: "syntax"
file_extension: "syntax"
programming_language: "syntax"
encoding_format: "text/plain"
code_repository:
code_path: "syntax"
commit_ref:
raw_url: "https://obsidian.md/help/syntax"
---
...
**Path:** syntax
**Language:** syntax · **Extension:** `.syntax`
...
2. Open **Raw** (`https://obsidian.md/help/syntax`) and clip that page, **or**
3. Select the code in the viewer before clipping.

Do not rely on Defuddle `Learn how to apply basic formatting to your notes, using [Markdown](https://daringfireball.net/projects/markdown/). For more advanced formatting syntax, refer to [Advanced formatting syntax](https://obsidian.md/help/advanced-syntax).
...
[^1]: This is a footnote.` for GitHub blobs — it captures page chrome, not the file.
