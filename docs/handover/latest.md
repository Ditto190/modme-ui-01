...
- **KM + beads phased plan:** Priority 1–4 implemented — unified `beads-hooks`, intake lifecycle, KM doc strangler, C4 ADRs, journal→inbox, e2e tests, km-metrics.
- **Canonical KM:** [docs/KNOWLEDGE_QUICKSTART.md](KNOWLEDGE_QUICKSTART.md) — inbox + beads → intake → KM brain.
