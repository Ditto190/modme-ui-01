...
<!-- Placeholder: the original v0.1.3 release notes were a verbatim duplicate of v0.1.4 in the upstream source. Distinct v0.1.3 entries could not be determined from this repository snapshot and should be backfilled by maintainers from the upstream release history. -->

_Release notes for v0.1.3 need maintainer backfill; the duplicated v0.1.4 content was removed to avoid publishing incorrect history._
