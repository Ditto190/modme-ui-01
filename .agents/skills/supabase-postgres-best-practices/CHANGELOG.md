...
<!-- Placeholder: the original v1.2.0 release notes were a verbatim duplicate of v1.3.0 in the upstream source. Distinct v1.2.0 entries could not be determined from this repository snapshot and should be backfilled by maintainers from the upstream release history. -->

_Release notes for v1.2.0 need maintainer backfill; the duplicated v1.3.0 content was removed to avoid publishing incorrect history._
